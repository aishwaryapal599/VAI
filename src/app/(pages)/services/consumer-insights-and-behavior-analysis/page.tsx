...
export default function Page({ params }: { params: { slug: string } }) {
  return (
    <section className=" prose mx-auto my-20 max-w-4xl space-y-8 ">
      <h2 className="our-services">Consumer Insights and Behavior Analysis</h2>
      ...
      <p className="pt-16">
        ...
        multifaceted approach that includes surveys, focus groups, and rigorous
        data analysis, analysts gain profound insights into the minds of
        consumers. By understanding what influences their choices and how they
        perceive products or services, analysts equip clients with invaluable
        knowledge essential for crafting effective marketing strategies and
      ...
      <p>
        ...
        understanding of consumer needs and desires. Armed with this knowledge,
        clients can tailor their offerings to better resonate with their target
        market, foster stronger brand connections, and drive business growth.
        Thus, the fusion of consumer research methodologies and data analysis
        empowers clients to make informed decisions that align with the evolving
