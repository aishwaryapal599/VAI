...
export default function Page() {
  return (
    <section className="prose mx-auto my-20 max-w-4xl space-y-8 ">
      <h2 className="our-services">Competitive Analysis</h2>
      <div className="relative h-96 w-full ">
        <Image
          className="h-full w-full rounded-lg object-cover shadow-lg"
          fill
          src="/assets/images/services/Competitive Analysis.png"
          alt="image"
        />
      </div>
      <p className="pt-16">
        ...
        competitors&apos; strategies, analysts unveil the tactics and approaches
        that have propelled their success or exposed vulnerabilities.
      </p>
      <p>
      ...
      <p>
        Market share analysis provides valuable benchmarks for clients to gauge
        their relative performance within the industry and identify areas for
        growth or consolidation. Armed with these insights, clients can devise
        informed strategies to capitalize on opportunities, mitigate risks, and
        stay ahead of competitors. Ultimately, the assessment of
        competitors&apos; strategies equips clients with the intelligence needed
        to navigate the competitive landscape strategically and position
